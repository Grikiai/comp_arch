...
### zodziu dali situ galima sudeti i registrus gal
column: 	 .word 0x0
integer: 	  .word 0x0
...
buffer:          .space 0x10 # ar uzteks tiek vietos

.text

	  # lets open file input.csv for reading
...
readFile:
	...
	li   a7, 63                       # "read a file" function
  	...
  	### sioje vietoje patikriname kuri column, jei 4ta, tai skaitome i stack; 
  	j readFile
...
readNumber:
	...
	li   a7, 63                       # "read a file" function
	la   a1, buffer  
  	lw   a0, fileHandle1                      # ... where to save read data
  	li   a2, 1                        # ... number of bytes to read
  	ecall 
...
sort:
	...
	blt s0, s2, switchf
  	...
  	#### cia asertiname kad galas, pereiname i end
  	j sort
